...
def fit(self, dataset: DatasetH, evals_result=dict(), save_path=None):
    ...
    # Initialize best_param with the current model state.
    ...
    for step in range(self.n_epochs):
        ...
        # Only update best_param if val_score is valid and better than best_score
        if val_score is not None and not np.isnan(val_score) and val_score > best_score:
